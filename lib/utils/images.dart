class Images {
  ...
  static String get arrow => 'arrow'.svg;
  ...
  static String get earnPoints => 'earn_points'.svg;

  static String get bookings => 'bookings'.png;

  static String get guest => 'guest'.png;

  static String get gift => 'gift'.svg;

  static String get points => 'points'.svg;
  ...
  static String get mobileScreen => 'mobile_screen'.svg;
  ...
  static String get tireImage => 'tire_icon'.png;
